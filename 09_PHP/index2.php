<?php
    ...
    // Zadatak 4. dodaj navformaciju (sa prethodnog casa vidi)
    ...
    // Zadatak 6. jednostavnije resenje

    $eur = 100;
    $kursEurDin = 117.5;
    $kursDolDin = 106.7;
    $dol = ($eur * $kursEurDin) / $kursDolDin;  /* zagrade gde treba a ne svuda, ovde ne mora npr */
    echo "<hr>";
    echo "Vrednost u dolarima nakon konverzije: " . $dol;
    echo "<hr>";

    // Zadatak 7. , 8, 9 domaci

    // Zadatak 10.  klasicna proporcija
